...
csv_file2 = csv.writer(open("./result/all.csv", 'a'))
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
credentials = ServiceAccountCredentials.from_json_keyfile_name('gas-api-test-8f71ed6dee54.json', scope)
gc = gspread.authorize(credentials)
wks = gc.open_by_key('1ZBWcdrbS3KIim7linkMdjAewSxPQVHR4-yFLrCIc9uQ').sheet1
print(wks)
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++
TABLE_SIZE = 8
WHITE = 0#DO NOT TOUCH
BLACK = 1#DO NOT TOUCH
# human:0
# computer:1~
PLAYER_FLG_B = 2
PLAYER_FLG_W = 2
